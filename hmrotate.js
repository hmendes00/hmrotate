...
(function ( $ ) {
    $.fn.hmRotate = function(options) {
        ...
        clicker.attr("data-hmrotate-api-angle", "0");
        ...
        $(handler).addClass("hmrotate-api-rotate-symbol");
            ...
            if(!hold){
                ...
                timeout = setInterval(function(){
                    if(mousemoving){
                        ...
                        if(clicker.attr("data-hmrotate-api-angle") != _angle){
                            clicker.attr("data-hmrotate-api-angle", _angle);
